...
public class JWTServiceTest {
    ...
    public void decryptTokenTest() {
        ...
        Assert.assertEquals("/recipes,/comments,/images", claims.get("allowedReadResources"));
        Assert.assertEquals("/recipes,/comments,/images", claims.get("allowedCreateResources"));
        Assert.assertEquals("/recipes,/comments,/images", claims.get("allowedUpdateResources"));
        Assert.assertEquals("/recipes,/comments,/images", claims.get("allowedDeleteResources"));
    }
